...
test('Dynamic elements are absent by default', async ({ page }) => { //1
  const addRemoveElementsPage = new AddRemoveElementsPage(page)
...
test('Single element can be added', async ({ page }) => { //2
  const addRemoveElementsPage = new AddRemoveElementsPage(page)
  await addRemoveElementsPage.goto()
...
test('Single element can be deleted', async ({ page }) => { //3
  const addRemoveElementsPage = new AddRemoveElementsPage(page)
  await addRemoveElementsPage.goto()
  await addRemoveElementsPage.clickAddElementsButton()
...
test('Multiple elements can be added', async ({ page }) => { //4
  const addRemoveElementsPage = new AddRemoveElementsPage(page)
  await addRemoveElementsPage.goto()
...
test('First element can be removed', async ({ page }) => { //5
  const addRemoveElementsPage = new AddRemoveElementsPage(page)
  await addRemoveElementsPage.goto()
...
test('Second element can be removed', async ({ page }) => { //6
  const addRemoveElementsPage = new AddRemoveElementsPage(page)
  await addRemoveElementsPage.goto()
  await addRemoveElementsPage.clickAddElementsButton(2)
...
test('Multiple elements can be completely deleted', async ({ page }) => { //7
  const addRemoveElementsPage = new AddRemoveElementsPage(page)
  await addRemoveElementsPage.goto()
  await addRemoveElementsPage.clickAddElementsButton(3)
  await addRemoveElementsPage.clickDeleteButton(1)
