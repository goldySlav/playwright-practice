...
test('First checkbox is unchecked by default', async ({ page }) => { //1
  const checkboxesPage = new CheckboxesPage(page)
...
test('First checkbox can be checked', async ({ page }) => { //2
  const checkboxesPage = new CheckboxesPage(page)
  await checkboxesPage.goto()
...
test('First checkbox can be unchecked', async ({ page }) => { //3
  const checkboxesPage = new CheckboxesPage(page)
  await checkboxesPage.goto()
...
test('Second checkbox is checked by default', async ({ page }) => { //4
  const checkboxesPage = new CheckboxesPage(page)
  await checkboxesPage.goto()
...
test('Second checkbox can be unchecked', async ({ page }) => { //5
  const checkboxesPage = new CheckboxesPage(page)
  await checkboxesPage.goto()
...
test('Second checkbox can be checked', async ({ page }) => { //6
  const checkboxesPage = new CheckboxesPage(page)
  await checkboxesPage.goto()
